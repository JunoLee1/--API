...
export class PlanReportRepository {
  ...
  create(dto: CreatePlanReportDto, createdById: number) {
    const data: Prisma.PlanReportUncheckedCreateInput = {
      title: dto.title,
      purpose: dto.purpose,
    ...
    if (dto.extraFields !== undefined) {
      data.extraFields = dto.extraFields as Prisma.InputJsonValue
    }
    return this.prisma.planReport.create({ data, include: PLAN_INCLUDE })
  }
