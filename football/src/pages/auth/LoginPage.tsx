...
const DEV_ACCOUNTS: { group: string; accounts: { label: string; email: string }[] }[] = [
  ...
  },
  {
    ...
    accounts: [
      ...
      { label: '경영지원부서장', email: 'biz.support@club.com' },
      { label: '운영인프라부서장', email: 'ops.manager@club.com' },
      { label: '시설관리팀장', email: 'facility.manager@club.com' },
      { label: '시설관리직원', email: 'facility.staff@club.com' },
      { label: '의료기기관리팀장', email: 'medical.equipment@club.com' },
      { label: 'IT자산관리팀장', email: 'it.manager@club.com' },
