...
- [x] **Step 1: Write payroll.routes.ts**
...
- [x] **Step 2: Register in apiRouter.ts**
...
- [x] **Step 3: TypeScript build check**
...
- [x] **Step 4: Run all payroll tests**
