...
- [x] **Step 1: Create the repository file**
...
- [x] **Step 1: Write failing tests for pure service functions**
...
- [x] **Step 5: Create the routes file**
...
- [x] **Step 6: Register in apiRouter**
...
- [x] **Step 2: Create the API service**
...
- [x] **Step 1: Add i18n keys to admin.json**
...
- [x] **Step 2: Add nav i18n key to common.json**
...
- [x] **Step 5: Add nav item in AppShell.tsx**
